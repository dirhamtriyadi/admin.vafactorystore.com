                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Tambah Order Pelacakan</h3>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('order-tracking.store') }}" method="POST">
                                @csrf
                                <div class="mb-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="tracking_id" name="tracking_id">
                                            ...
                                            @foreach ($trackings as $i => $tracking)
                                                <option value="{{ $tracking->id }}" {{ old('tracking_id') == $tracking->id ? 'selected' : ''  }}>{{ $tracking->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
