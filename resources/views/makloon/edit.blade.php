                            ...
                            <form action="#" id="makloon-form">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name"
                                        value="{{ old('name') ? old('name') : $makloon->name }}">
                                </div>
                                        ...
                                        <select class="form-control select2" id="customer_id" name="customer_id">
                                            ...
                                            @foreach ($customers as $i => $customer)
                                                <option value="{{ $customer->id }}"
                                                    {{ (old('customer_id') == $customer->id) | ($makloon->customer_id == $customer->id) ? 'selected' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group date mb-3" id="reservationdate" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input"
                                            ...
                                            value="{{ old('date') ? old('date') : $makloon->date }}">
        ...
        $(function() {
            ...
            $('#add-item-makloon-form').on('submit', function(e) {
                ...
                for (let i = 0; i < storedFormDataLength; i++) {
                    ...
                    tr.append($('<td>').append($('<a>').attr('href', '#').addClass('btn btn-danger').text(
                        'Hapus').on('click', function(e) {
                        e.preventDefault();
                        storedFormData.splice(i, 1);
                        localStorage.setItem('formData', JSON.stringify(storedFormData));
