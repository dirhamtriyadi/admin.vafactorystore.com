                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Edit Bahan Baku Keluar</h3>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between mb-3">
                                <a href="{{ route('raw-material-out.index') }}" class="btn btn-warning"><i
                                        class="fa fa-arrow-left" aria-hidden="true"></i> Kembali</a>
                            </div>
                            <form action="{{ route('raw-material-out.update', $rawMaterialIn->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="mb-3">
                                    <label for="name" class="form-label">Bahan Baku <span
                                    ...
                                    <select class="form-control select2" id="raw_material_id" name="raw_material_id">
                                        ...
                                        @foreach ($rawMaterials as $item => $i)
                                            <option value="{{ $i->id }}"
                                                {{ (old('raw_material_id') == $i->id) | ($rawMaterialIn->raw_material_id == $i->id) ? 'selected' : '' }}>
                                                {{ $i->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="qty" name="qty"
                                        value="{{ old('qty') ? old('qty') : $rawMaterialIn->qty }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group date mb-3" id="reservationdate" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input"
                                            ...
                                            value="{{ old('date') ? old('date') : $rawMaterialIn->date }}">
