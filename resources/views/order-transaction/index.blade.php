                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column justify-content-end mb-3">
                                <div class="d-flex justify-content-end">
                                    @can('order-transaction.create')
                                        <a href="{{ route('order-transaction.create') }}" class="btn btn-primary mb-3"><i
                                        ...
                                        <form action="{{ route('order-transaction.index') }}" method="GET">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="search" id="search" class="form-control"
                                                    placeholder="Cari Order Transaksi" value="{{ $search }}">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover table-striped">
                                    ...
                                    <tbody>
                                        @forelse ($orderTransactions as $i => $orderTransaction)
                                            <tr>
                                                <td>{{ $i + $orderTransactions->firstitem() }}</td>
                                                <td>{{ $orderTransaction->order->order_number }}</td>
                                                <td>{{ isset($orderTransaction->createdBy->name) ? $orderTransaction->createdBy->name : '' }}
                                                </td>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                @can('order-transaction.edit')
                                                                    <li>
                                                                        <a href="{{ route('order-transaction.edit', $orderTransaction->id) }}"
                                                                ...
                                                                @can('order-transaction.delete')
                                                                    <li>
                                                                        <form
                                                                            action="{{ route('order-transaction.destroy', $orderTransaction->id) }}"
                                                                            method="post">
                                                                            @csrf
                                                                            @method('delete')
                                                                            <button type="submit"
