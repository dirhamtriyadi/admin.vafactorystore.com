                                ...
                                <div class="d-flex flex-wrap">
                                    <div class="form-group mr-3">
                                        ...
                                        <select class="form-control select2 select2-hidden-accessible" style="width: 100%;"
                                            data-select2-id="1" tabindex="-1" aria-hidden="true" name="product_id"
                                            id="product_id">
                                            <option selected="selected" data-select2-id="" value="">-- Pilih Product
                                                --</option>
                                            @foreach ($products as $i => $product)
                                                <option value="{{ $product->id }}" data-product="{{ $product }}"
                        ...
                        <div class="card-body">
                            <form>
                                    ...
                                    <div class="d-flex flex-wrap">
                                        <div class="form-group mr-3">
                                            ...
                                            <select class="form-control select2 select2-hidden-accessible"
                                                ...
                                                <option selected="selected" data-select2-id="" value="">-- Pilih
                                                    Customer --</option>
                                                @foreach ($customers as $i => $customer)
                                                    <option value="{{ $customer->id }}" data-customer="{{ $customer }}"
                                        ...
                                        <div class="d-flex">
                                            <div class="form-group mr-3">
                                                ...
                                                <select class="form-control select2 select2-hidden-accessible"
                                                    style="width: 100%;" data-select2-id="3" tabindex="-1"
                                                    aria-hidden="true" name="payment_method_id" id="payment_method_id">
                                                    <option selected="selected" data-select2-id="" value="">-- Pilih
                                                        Jenis Pembayaran --</option>
                                                    @foreach ($paymentMethods as $i => $paymentMethod)
                                                        <option value="{{ $paymentMethod->id }}"
                                                            data-paymentMethod="{{ $paymentMethod }}"
                                                            data-select2-id="{{ $paymentMethod->id }}">
                                ...
                                <div class="d-flex justify-content-between flex-wrap mb-3">
                                    ...
                                    <div>
                                        <input type="text" class="form-control mask-money" id="total"
                                ...
                                <div class="d-flex justify-content-between mb-3">
                                    ...
                                    <div>
                                        <input type="text" class="form-control mask-money" id="cash"
                                            name="cash" value="0">
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-row justify-content-between flex-wrap mb-3">
                                    ...
                                    <div class="col-3">
                                        <a class="btn btn-outline-primary" style="width: 90px"
                                            id="100000">+100.000</a>
                                    </div>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="d-flex justify-content-between mb-3">
                                    ...
                                    <div>
                                        <input type="text" id="status-cash" class="form-control mask-money"
                                            value="0" readonly>
