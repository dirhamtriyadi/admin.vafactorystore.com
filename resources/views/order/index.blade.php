                                        ...
                                        <form action="{{ route('order.index') }}" method="GET">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="search" id="search" class="form-control"
                                                    placeholder="Cari Order" value="{{ $search }}">
                                    ...
                                    <tbody>
                                        @forelse ($orders as $i => $order)
                                            <tr>
                                                ...
                                                <td>{{ isset($order->createdBy->name) ? $order->createdBy->name : '' }}
                                                </td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control mask-money" id="print_type_price"
                                name="print_type_price" readonly>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control mask-money" id="subtotal" name="subtotal"
                                readonly>
                        </div>

                        <div class="mb-3">
                            <label for="discount" class="form-label">Diskon</label>
                            <input type="text" class="form-control mask-money" id="discount" name="discount"
                                readonly>
                        </div>

                        <div class="mb-3">
                            <label for="total" class="form-label">Total</label>
                            <input type="text" class="form-control mask-money" id="total" name="total"
                                readonly>
                        </div>
