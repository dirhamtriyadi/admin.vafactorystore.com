...
@section('content-header')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>List Data Jenis Pembayaran</h1>
                </div>
                <div class="col-sm-6">
                            ...
                            <div class="d-flex flex-column justify-content-end mb-3">
                                <div class="d-flex justify-content-end">
                                    @can('payment-method.create')
                                        <a href="{{ route('payment-method.create') }}" class="btn btn-primary mb-3"><i
                                                class="fa fa-plus-square" aria-hidden="true"></i> Tambah</a>
                                    @endcan
                                </div>
                                <div class="d-flex flex-col flex-wrap justify-content-between">
                                    <div class="mb-3">
                                        <form action="{{ route('payment-method.index') }}" method="GET">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                @can('payment-method.delete')
                                                                    <li>
                                                                        <form
                                                                            action="{{ route('payment-method.destroy', $paymentMethod->id) }}"
