                                    ...
                                    <tbody>
                                        @forelse ($rawMaterials as $i => $rawMaterial)
                                            <tr>
                                                ...
                                                <td>{{ $rawMaterial->createdBy->name }}</td>
                                                <td class="text-center">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                @can('raw-material.edit')
                                                                    <li>
                                                                        <a href="{{ route('raw-material.edit', $rawMaterial->id) }}"
                                                                ...
                                                                @can('raw-material.delete')
                                                                    <li>
                                                                        <form
                                                                            action="{{ route('raw-material.destroy', $rawMaterial->id) }}"
                                                    ...
                                                    @endcanany
                                                    {{-- @can('raw-material.edit')
                                                        <a href="{{ route('raw-material.edit', $rawMaterial->id) }}" class="btn btn-warning btn-sm">Edit</a>
                                                    @endcan
                                                    @can('raw-material.delete')
