                            ...
                            <div class="d-flex flex-column justify-content-end mb-3">
                                <div class="d-flex justify-content-end">
                                    @can('raw-material-in.create')
                                        <a href="{{ route('raw-material-in.create') }}" class="btn btn-primary mb-3"><i
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                @can('raw-material-in.edit')
                                                                    <li>
                                                                        <a href="{{ route('raw-material-in.edit', $i->id) }}"
                                                                ...
                                                                @can('raw-material-in.delete')
                                                                    <li>
                                                                        <form
                                                                            action="{{ route('raw-material-in.destroy', $i->id) }}"
    ...
    <script>
        $(function() {
            const table = $('#table').DataTable({
                ...
                ajax: {
                    url: "{{ route('raw-material-in.get-raw-material-in-data-table') }}",
                },
                autoWidth: false,
                columnDefs: [{
                    targets: 0,
