                            ...
                            <form action="{{ route('cash-flow.update', $cashFlow->id) }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group date mb-3" id="reservationdate" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate" name="transaction_date" value="{{ old('transaction_date') ? old('transaction_date') : $cashFlow->transaction_date }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="amount" name="amount" value="{{ old('amount') ? old('amount') : $cashFlow->amount }}">
                                </div>

                                <div class="mb-3">
                                    <div class="form-group">
                                        <label for="cash_flow_type" class="form-label">Type</label>
                                        <select class="form-control" id="cash_flow_type" name="cash_flow_type">
